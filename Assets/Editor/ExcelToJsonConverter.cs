...
public class ExcelToJsonConverter
{
    ...
    /// <param name="filePath">File path.</param>
    private Excel.IExcelDataReader GetExcelDataReaderForFile(string filePath)
    {
    ...
    private DataSet GetExcelDataSet(string filePath)
    {
        ...
        Excel.IExcelDataReader excelReader = GetExcelDataReaderForFile(filePath);
    ...
    private DataTable GetExcelSheetData(Excel.IExcelDataReader excelReader)
    {
        if (excelReader == null)
        {
